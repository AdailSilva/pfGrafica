...
import com.adailsilva.pfgrafica.dao.ContatosDaoImp;
...
public class ContatoMB {
    ...
    public void sendEmail() throws EmailException, UnsupportedEncodingException {
        ...
        try {
            ...
            //Formatando charset (Codificação de caracteres)
            email.setContent(contato, "text/html; charset=iso-8859-1");            
            //Utilize o hostname do seu provedor de email
            email.setHostName("smtp.gmail.com");
            //Quando a porta utilizada não é a padrão (gmail = 465)
            email.setSmtpPort(465);
            //Adicione os destinatários
            email.addTo("paulofylho@hotmail.com", "pfGráfica Tianguá");
            ...
            email.setSSL(true);
            email.setAuthentication("pfgraficatiangua@gmail.com", "paulofilhopfgrafica");
            email.send();
