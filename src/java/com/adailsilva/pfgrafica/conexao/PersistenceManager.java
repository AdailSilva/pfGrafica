package com.adailsilva.pfgrafica.conexao;
...
public class PersistenceManager {
    ...
    protected void createEntityManagerFactory() {
        ...
        this.emf = Persistence.createEntityManagerFactory("PFGraficaPU", configProperty());
        if (DEBUG) {
    ...
    public HashMap<String, Object> configProperty() {        
        ...
        prop.put("javax.persistence.jdbc.password", "@Hacker101");        
